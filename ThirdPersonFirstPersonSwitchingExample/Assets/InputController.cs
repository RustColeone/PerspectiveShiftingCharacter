...
public class @InputController : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Movement"",
            ""id"": ""10626fef-1142-4afa-b3ac-de0ddfca4abd"",
            ""actions"": [
                {
                    ""name"": ""Move"",
                    ""type"": ""PassThrough"",
                    ""id"": ""87532d1e-bffb-4aa3-a421-db37804a6e56"",
                ...
                },
                {
                    ""name"": ""Camera"",
                    ""type"": ""PassThrough"",
                    ""id"": ""641a3582-4b71-4ac8-b07b-20f9bfe606f8"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""c3a008b8-7b81-4d3b-82fd-9bedafa2c400"",
                ...
                {
                    ""name"": ""WASD"",
                    ""id"": ""7839ae79-f5dd-4185-8e2a-f527a0d88c97"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""9cf9501c-5774-42ef-b6bd-53b66ec4e172"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""9f265cd0-1cc3-4e72-baff-279f932ec3ce"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""4f51d4b2-ce34-4206-ba13-25636e4ba5a3"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""57ee9e96-fb1b-4fc7-9cf0-6402e38038a1"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""c207ddb9-1dc6-4af8-9e2e-de65fe254378"",
                ...
                {
                    ""name"": """",
                    ""id"": ""bf1ff90c-0576-42f7-8d1a-c7ee7bcbcf62"",
                    ""path"": ""<Mouse>/delta"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
        ...
        {
            ""name"": ""Actions"",
            ""id"": ""a89881c6-332c-4472-ac96-bf3a242a022e"",
            ""actions"": [
                {
                    ""name"": ""ChangeView"",
                    ""type"": ""Button"",
                    ""id"": ""32a99555-4b80-48d1-8859-74d5c06361e1"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""8e315ff4-5a85-4958-83eb-41474d7f819c"",
                ...
                {
                    ""name"": """",
                    ""id"": ""99495dc4-5783-42ea-8346-95383fc369a2"",
                    ""path"": ""<Keyboard>/v"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
